...
struct ModulesGraphTests {
    ...
    func customProductCannotBeTargetDependency() throws {
        ...
        #expect {
            ...
            return error.description == "target 'App' cannot depend on custom product 'Firmware' from package 'device'; custom products are built by product-builder plugins and cannot be linked as target dependencies"
        }
    }
