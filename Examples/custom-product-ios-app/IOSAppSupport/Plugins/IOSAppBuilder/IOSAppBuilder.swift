...
struct IOSAppBuilder: ProductBuilderPlugin {
    func createBuildPlan(
        ...
        for resourceBundle in input.resourceBundleURLs {
            arguments += ["--resource-bundle", resourceBundle.path]
        }
            ...
            return ProductBuilderPlan(
                commands: [
                    .buildCommand(
                        ...
                        outputFiles: [archive, ipa, report]
                    ),
                ],
                outputFiles: [ipa, report],
                outputDirectories: [archive]
            )
        case .simulator:
            ...
            return ProductBuilderPlan(
                commands: [
                    .buildCommand(
                        ...
                        arguments: arguments,
                        inputFiles: [input.aggregateStaticLibraryURL] + input.resourceURLs,
                        outputFiles: [app, report]
                    ),
                ],
                outputFiles: [report],
                outputDirectories: [app]
            )
        }
    }
}
...
private enum BuilderError: Error, CustomStringConvertible {
    ...
    var description: String {
        ...
        case .unsupportedType(let value):
            return "unsupported custom product type '\(value)'"
